			...
			aboutMenuItem.addActionListener(new ActionListener()
				{
					public void actionPerformed(ActionEvent e)
						...
						about.add(new JLabel("<html><b><center>David's Weather Clock<br><font size=-2>by David E. Powell</font></center></b>" 
								+"<br>The clock face tells the weather as well as"
								+"<br>the time. The hue (color) of the clock face"
								...
								+"<br>of the clock face depends on how close the"
								+"<br>time of day is to noon.  The face of the"
								+"<br>clock also shows a rough estimate of the"
								+"<br>phase of the moon.  The red triangle shows"
								+"<br>the wind speed and direction."
